...
do
    ...
    echo "set inputDir /lustre/expphy/volatile/clas12/bclary/simulation_out/elastic/beam2/field_tp1sm1/" >> toCook_${i}.clara
    echo "set outputDir /work/clas12/bclary/CLAS12/electron_studies/elastic/sim/recon/field_tp1sm1/"  >> toCook_${i}.clara
    ...
    /work/clas12/bclary/CLAS12/validation/validationBrandon/clara-5b.7.6/bin/clara-shell toCook_${i}.clara 
