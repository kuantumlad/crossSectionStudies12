...
///
///  Then call function:  filter_clas12("data_5b.6.1/4013.root", "output/4013.root", 4013)
///                       filter_clas12("data_5b.6.1/4014.root", "output/4014.root", 4014)
///                       filter_clas12("data_5b.6.1/4015.root", "output/4015.root", 4015)
///                       filter_clas12("data_5b.6.1/4018.root", "output/4018.root", 4018)
///                       filter_clas12("data_5b.6.1/4021.root", "output/4021.root", 4021)
///                       filter_clas12("data_5b.6.1/4022.root", "output/4022.root", 4022)
///                       filter_clas12("data_5b.6.1/4030.root", "output/4030.root", 4030)
///                       filter_clas12("data_5b.6.1/4032.root", "output/4032.root", 4032)
///                       filter_clas12("data_5b.6.1/4053.root", "output/4053.root", 4053)
///                       filter_clas12("data_5b.6.1/4078.root", "output/4078.root", 4078)
///                       filter_clas12("data_5b.6.1/3958.root", "output/3958.root", 3958)
///                       filter_clas12("data_5b.6.1/3959.root", "output/3959.root", 3959)
///                       filter_clas12("data_5b.6.1/4078.root", "output/3963.root", 3963)
///                       filter_clas12("data_5b.6.1/2391_1.root", "output/2391.root", 2391)
///                       filter_clas12("data_5b.6.1/2476_1.root", "output/2476.root", 2476)
///                       filter_clas12("data_5b.6.1/2587_1.root", "output/2587.root", 2587)
///
...
Int_t filter_clas12_v4( Char_t *inFile, Char_t *outputfile, int run)
{
...
bool DC_hit_position_region1_fiducial_cut(int j){
  ...
  double radius2_DCr1 = pow(30,2)-pow(y1_rot,2);    // cut out the inner circle
...
bool DC_hit_position_region2_fiducial_cut(int j){
  ...
  double radius2_DCr2 = pow(45,2)-pow(y2_rot,2);    // cut out the inner circle
...
bool DC_hit_position_region3_fiducial_cut(int j){
  ...
  double radius2_DCr3 = pow(50,2)-pow(y3_rot,2);    // cut out the inner circle
...
bool DC_hit_position_region2_fiducial_cut_hadrons_negative(int j){
  ...
  double radius2_DCr2 = pow(49,2)-pow(y2_rot,2);    // cut out the inner circle
...
bool DC_hit_position_region3_fiducial_cut_hadrons_negative(int j){
  ...
  double radius2_DCr3 = pow(63,2)-pow(y3_rot,2);    // cut out the inner circle
...
bool prot_beta_cut(int j, int run){
  ...
  double prot_mean_p0[] = {1.00401, 1.00528, 1.00654, 1.00591, 1.00188, 1.00275};
  double prot_mean_p1[] = {0.857477, 0.844641, 0.849807, 0.856546, 0.868042, 0.865406};
  double prot_sigma_p0[] = {0.000523482, 0.000246276, 0.000353689, 0.0010485, 2.31291e-05, 0.000327357};
  double prot_sigma_p1[] = {0.0116411, 0.0127507, 0.0134067, 0.0111433, 0.0115489, 0.0118189};
...
bool pip_beta_cut(int j, int run){
  ...
  double pip_mean_p0[] = {0.999323, 0.999618, 0.999888, 0.999911, 0.998791, 0.998889};
  double pip_mean_p1[] = {0.0180815, 0.0170855, 0.017013, 0.0180826, 0.0170883, 0.0163666};
  double pip_sigma_p0[] = {0.0010424, 0.00154015, 0.00179487, 0.00224062, 0.000698921, 0.00103443};
  double pip_sigma_p1[] = {0.00666186, 0.00601759, 0.00596096, 0.00509339, 0.00670074, 0.00668428};
...
bool pim_beta_cut(int j, int run){
  ...
  double pim_mean_p0[] = {0.99633, 0.99649, 0.996569, 0.996175, 0.99659, 0.996652};
  double pim_mean_p1[] = {0.0152746, 0.0157846, 0.0153856, 0.0151136, 0.014046, 0.0140012};
  double pim_sigma_p0[] = {6.31538e-05, -0.000321628, 0.000343613, 3.57703e-05, -0.000221968, -0.000303001};
  double pim_sigma_p1[] = {0.00683594, 0.00730936, 0.00658419, 0.00663091, 0.00704007, 0.0074271};
...
bool Kp_beta_cut(int j, int run){
  ...
  double Kp_sigma_p0[] = {0.0010424, 0.00154015, 0.00179487, 0.00224062, 0.000698921, 0.00103443};   // copied from pip
  double Kp_sigma_p1[] = {0.00666186, 0.00601759, 0.00596096, 0.00509339, 0.00670074, 0.00668428};   // copied from pip
...
bool Km_beta_cut(int j, int run){
  ...
  double Km_sigma_p0[] = {6.31538e-05, -0.000321628, 0.000343613, 3.57703e-05, -0.000221968, -0.000303001};    // copied from pim
  double Km_sigma_p1[] = {0.00683594, 0.00730936, 0.00658419, 0.00663091, 0.00704007, 0.0074271};              // copied from pim
...
bool prot_delta_beta_cut(int j, int run){
  ...
  double mean = -0.006148;
  double sigma = 0.01054;
...
bool pip_delta_beta_cut(int j, int run){
  ...
  double mean = -0.0001255;
  double sigma = 0.009212;
  double delta_beta_min = mean - 3 * sigma;
  double delta_beta_max = mean + 3 * sigma;
...
bool pim_delta_beta_cut(int j, int run){
  ...
  double mean = 0.001477;
  double sigma = 0.008281;
  double delta_beta_min = mean - 3 * sigma;
  double delta_beta_max = mean + 3 * sigma;
...
bool Kp_delta_beta_cut(int j, int run){
  ...
  double mean = -0.0009233;
  double sigma = 0.009655;
  double delta_beta_min = mean - 3 * sigma;
  double delta_beta_max = mean + 3 * sigma;
...
bool Km_delta_beta_cut(int j, int run){
  ...
  double mean = -0.002704;
  double sigma = 0.009144;
  double delta_beta_min = mean - 3 * sigma;
  double delta_beta_max = mean + 3 * sigma;
