...
//vector<short>          *vHelic    = 0;     // helicity
   ...
   //added
   vector<float>  *vCC_x        = 0;
   vector<float>  *vCC_y        = 0;
   vector<float>  *vCC_z        = 0;
...
/// general particle properties and additional particle bank properties for non identified particles:
  ...
  float part_CC_HTCC_x[BUFFER], part_CC_HTCC_y[BUFFER], part_CC_HTCC_z[BUFFER];
...
/// a) electron ID:
  ...
  TH2F *hist_HTCC_x_vs_y[FD_eid_cuts];
  TH2F *hist_HTCC_x_vs_y_wnphe[FD_eid_cuts];
...
TH2F *create_hist_HTCC_x_vs_y(int cutnum);
TH2F *create_hist_HTCC_x_vs_y_wnphe(int cutnum);
...
Int_t filter_clas12H4( Char_t *inFile, Char_t *outputfile, int run)
{
...
/// ////////////////////////////////////////////////////////////////////////////
   ...
   anaTree->SetBranchAddress("REC_Cherenkov_x", &vCC_x);
   anaTree->SetBranchAddress("REC_Cherenkov_y", &vCC_y);
   anaTree->SetBranchAddress("REC_Cherenkov_z", &vCC_z);
...
for(Int_t i = 0; i < 11; i++){ 
  ...
  create_hist_HTCC_x_vs_y(i);
  create_hist_HTCC_x_vs_y_wnphe(i);
...
// all particles with negative charge
  ...
  if(FD_eid_charge_check[i]){   // only particles which passed the default pid cut
    ...
    //added htcc x-y hit position
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[0]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[0]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// default PID  (neg. charge is fulfilled for all)
  ...
  if(FD_eid_default_PID_check[i]){  
    ...
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[1]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[1]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// EC cuts
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i]){  
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[2]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[2]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_sampling_fraction_check[i]){  
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[3]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[3]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_hit_position_fiducial_check[i]){   
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[4]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[4]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// DC cuts
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_DC_hit_position_region1_fiducial_check[i]){   
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[5]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[5]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_DC_hit_position_region3_fiducial_check[i]){   
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[6]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[6]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// vertex cut
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_DC_z_vertex_check[i]){  
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[7]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[7]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// all other
  ...
  if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] && FD_eid_EC_sampling_fraction_check[i] && FD_eid_EC_hit_position_fiducial_check[i]
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[8]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[8]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// all cuts
  ...
  if(FD_eid_all_check[i]){ 
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[9]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[9]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
// inverse cut  (neg. charge but no PID 11)
  ...
  if(FD_eid_default_PID_check[i] == false && FD_eid_charge_check[i] == true ){  
    ...
    //added htcc x-y hit position 
    if(part_p[i] > 0 ){
      hist_HTCC_x_vs_y[10]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i]); 
      hist_HTCC_x_vs_y_wnphe[10]->Fill(part_CC_HTCC_x[i],part_CC_HTCC_y[i], part_CC_HTCC_nphe[i]);
    }
...
//added
TH2F* create_hist_HTCC_x_vs_y(const int cutnum){
  char name[100];
  sprintf(name,"HTCC_x_vs_y_cut_%02d", cutnum);
  hist_HTCC_x_vs_y[cutnum] = new TH2F(name, name, 1000,-150,150, 1000, -150, 150);   
  hist_HTCC_x_vs_y[cutnum]->GetXaxis()->SetTitle("#x_{CC} (cm)");
  hist_HTCC_x_vs_y[cutnum]->GetYaxis()->SetTitle("#y_{CC} (cm)");
  return(hist_HTCC_x_vs_y[cutnum]);
}

TH2F* create_hist_HTCC_x_vs_y_wnphe(const int cutnum){
  char name[100];
  sprintf(name,"HTCC_x_vs_y_wnphe_cut_%02d", cutnum);
  hist_HTCC_x_vs_y_wnphe[cutnum] = new TH2F(name, name, 1000, -150, 150, 1000, -150, 150);   
  hist_HTCC_x_vs_y_wnphe[cutnum]->GetXaxis()->SetTitle("#x_{CC} (cm)");
  hist_HTCC_x_vs_y_wnphe[cutnum]->GetYaxis()->SetTitle("#y_{CC} (cm)");
  return(hist_HTCC_x_vs_y_wnphe[cutnum]);
}
...
void assign_particles(void){
  ...
  if(TRK_Nentries > 0){
    for(int i = 0; i < TRK_Nentries; i++){
      if(vTRK_pindex->at(i) < BUFFER && vTRK_detector->at(i) == 6){     // DC - need to add layers?
  ...
  if(Traj_Nentries > 0){
    for(int i = 0; i < Traj_Nentries; i++){
      ...
      if( vTraj_pindex->at(i) < BUFFER && vTraj_detID->at(i) == 15 ){
	//std::cout << " here " << std::endl;
	  part_CC_HTCC_x[vTraj_pindex->at(i)] = vTraj_x->at(i);
	  part_CC_HTCC_y[vTraj_pindex->at(i)] = vTraj_y->at(i);
	  part_CC_HTCC_z[vTraj_pindex->at(i)] = vTraj_z->at(i);
	}
...
bool ele_default_PID_cut(int j){
  //std::cout << " part pid " << vpart_pid->at(j) << std::endl;
