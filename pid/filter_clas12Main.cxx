...
TH2F* create_hist_EC_total_sampling_fraction_sec1(const int cutnum){
  ...
  hist_EC_total_sampling_fraction_sec1[cutnum] = new TH2F(name, name, 1100,0.0,3.0, 600,0,0.6);    // sampling fraction plots
...
TH2F* create_hist_EC_total_sampling_fraction_sec2(const int cutnum){
  ...
  hist_EC_total_sampling_fraction_sec2[cutnum] = new TH2F(name, name, 1100,0,3.0, 600,0,0.6);   
...
TH2F* create_hist_EC_total_sampling_fraction_sec3(const int cutnum){
  ...
  hist_EC_total_sampling_fraction_sec3[cutnum] = new TH2F(name, name, 1100,0,3.0, 600,0,0.6);   
...
TH2F* create_hist_EC_total_sampling_fraction_sec4(const int cutnum){
  ...
  hist_EC_total_sampling_fraction_sec4[cutnum] = new TH2F(name, name, 1100,0,3.0, 600,0,0.6);   
...
TH2F* create_hist_EC_total_sampling_fraction_sec5(const int cutnum){
  ...
  hist_EC_total_sampling_fraction_sec5[cutnum] = new TH2F(name, name, 1100,0,3.0, 600,0,0.6);   
...
TH2F* create_hist_EC_total_sampling_fraction_sec6(const int cutnum){
  ...
  hist_EC_total_sampling_fraction_sec6[cutnum] = new TH2F(name, name, 1100,0,3.0, 600,0,0.6);   
