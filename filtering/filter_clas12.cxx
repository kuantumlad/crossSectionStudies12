    ...
    if( i < BUFFER){
      ...
      for(int k = 0; k < Npart; k++){
        ...
        if(use_own_PID_proton == true){ 
          ...
          selector = (FD_protid_default_PID_check[k] && part_theta[k]*180/Pival > 4.5 && part_theta[k]*180/Pival < 37) || (CD_protid_default_PID_check[k] && part_theta[k]*180/Pival > 35); 
        }
